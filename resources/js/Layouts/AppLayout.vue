        ...
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-white border-b border-gray-100">
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    ...
                    <div v-if="$page.props.user.permissions.includes('read categories')" class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink :href="route('categories.index')" :active="route().current('categories.*')">
                            Categories
                        </ResponsiveNavLink>
                    </div>

                    <div  v-if="$page.props.user.permissions.includes('read lessons')" class="pt-2 pb-3 space-y-1">
